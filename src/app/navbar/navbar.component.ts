...
constructor(public menu : IsOpenService, public lang: ChooseLangService ,public translate: TranslateService) {}
  ngOnInit(): void {
  ...
  openNavbar() {  
    ...
    setTimeout(() => {
      document.querySelector('.'+ this.lang.choosenLang).classList.add('checked');
    }, 100);
  }
